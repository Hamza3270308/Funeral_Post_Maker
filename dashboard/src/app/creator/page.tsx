      ...
      <aside className="tools-sidebar" style={{ borderRight: 'none', borderLeft: '1px solid var(--border-color)', display: 'flex', flexDirection: 'column', height: '100%', width: '340px' }}>
        ...
        {rightSidebarTab === 'flowers' && (
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflowY: 'hidden' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', overflowY: 'auto', paddingRight: '5px', flex: 1, maxHeight: '350px' }}>
              {[
                { id: 'floral_golden_eucalyptus', name: 'Golden Eucalyptus' },
                { id: 'floral_vintage_mourning_wreath', name: 'Mourning Wreath' },
                { id: 'floral_white_calla_lilies', name: 'Calla Lilies' },
                { id: 'floral_laurel_divider', name: 'Laurel Divider' },
                { id: 'floral_victorian_corner_rose', name: 'Victorian Corner Rose' },
                { id: 'floral_soft_hydrangea_bunch', name: 'Soft Hydrangea' },
                { id: 'floral_wildflower_meadow', name: 'Wildflower Meadow' },
                { id: 'floral_ivy_vine_arch', name: 'Ivy Vine Arch' },
                { id: 'floral_magnolia_bloom', name: 'Magnolia Bloom' },
                { id: 'floral_golden_wheat_sheaf', name: 'Golden Wheat Sheaf' },
                { id: 'floral_peace_dove_olive', name: 'Peace Olive Branch' },
                { id: 'floral_autumn_chrysanthemum', name: 'Chrysanthemums' },
                { id: 'floral_rosemary_remembrance', name: 'Rosemary Sprig' },
                { id: 'floral_silver_leaf_corner', name: 'Silver Leaf Corner' },
                { id: 'floral_delicate_snowdrops', name: 'White Snowdrops' },
                { id: 'floral_cymbidium_orchid', name: 'Cymbidium Orchid' },
                { id: 'floral_eucalyptus_wreath', name: 'Eucalyptus Wreath' },
                { id: 'floral_camellia_elegance', name: 'Blush Camellia' },
                { id: 'floral_golden_filigree_divider', name: 'Gold Filigree Divider' },
                { id: 'floral_forget_me_not_garland', name: 'Forget-me-not Garland' },
