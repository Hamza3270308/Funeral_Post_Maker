...
class MemorialElementsLibrary {
  ...
  static const List<MemorialGraphic> graphics = [
    MemorialGraphic(
      id: 'floral_golden_eucalyptus',
      category: 'Floral Designs',
      name: 'Golden Eucalyptus',
      imageFile: 'floral_golden_eucalyptus.png',
    ),
    MemorialGraphic(
      id: 'floral_vintage_mourning_wreath',
      category: 'Floral Designs',
      name: 'Mourning Wreath',
      imageFile: 'floral_vintage_mourning_wreath.png',
    ),
    MemorialGraphic(
      id: 'floral_white_calla_lilies',
      category: 'Floral Designs',
      name: 'Calla Lilies',
      imageFile: 'floral_white_calla_lilies.png',
    ),
    MemorialGraphic(
      id: 'floral_laurel_divider',
      category: 'Floral Designs',
      name: 'Laurel Divider',
      imageFile: 'floral_laurel_divider.png',
    ),
    MemorialGraphic(
      id: 'floral_victorian_corner_rose',
      category: 'Floral Designs',
      name: 'Victorian Corner Rose',
      imageFile: 'floral_victorian_corner_rose.png',
    ),
    MemorialGraphic(
      id: 'floral_soft_hydrangea_bunch',
      category: 'Floral Designs',
      name: 'Soft Hydrangea',
      imageFile: 'floral_soft_hydrangea_bunch.png',
    ),
    MemorialGraphic(
      id: 'floral_wildflower_meadow',
      category: 'Floral Designs',
      name: 'Wildflower Meadow',
      imageFile: 'floral_wildflower_meadow.png',
    ),
    MemorialGraphic(
      id: 'floral_ivy_vine_arch',
      category: 'Floral Designs',
      name: 'Ivy Vine Arch',
      imageFile: 'floral_ivy_vine_arch.png',
    ),
    MemorialGraphic(
      id: 'floral_magnolia_bloom',
      category: 'Floral Designs',
      name: 'Magnolia Bloom',
      imageFile: 'floral_magnolia_bloom.png',
    ),
    MemorialGraphic(
      id: 'floral_golden_wheat_sheaf',
      category: 'Floral Designs',
      name: 'Golden Wheat Sheaf',
      imageFile: 'floral_golden_wheat_sheaf.png',
    ),
    MemorialGraphic(
      id: 'floral_peace_dove_olive',
      category: 'Floral Designs',
      name: 'Peace Olive Branch',
      imageFile: 'floral_peace_dove_olive.png',
    ),
    MemorialGraphic(
      id: 'floral_autumn_chrysanthemum',
      category: 'Floral Designs',
      name: 'Chrysanthemums',
      imageFile: 'floral_autumn_chrysanthemum.png',
    ),
    MemorialGraphic(
      id: 'floral_rosemary_remembrance',
      category: 'Floral Designs',
      name: 'Rosemary Sprig',
      imageFile: 'floral_rosemary_remembrance.png',
    ),
    MemorialGraphic(
      id: 'floral_silver_leaf_corner',
      category: 'Floral Designs',
      name: 'Silver Leaf Corner',
      imageFile: 'floral_silver_leaf_corner.png',
    ),
    MemorialGraphic(
      id: 'floral_delicate_snowdrops',
      category: 'Floral Designs',
      name: 'White Snowdrops',
      imageFile: 'floral_delicate_snowdrops.png',
    ),
    MemorialGraphic(
      id: 'floral_cymbidium_orchid',
      category: 'Floral Designs',
      name: 'Cymbidium Orchid',
      imageFile: 'floral_cymbidium_orchid.png',
    ),
    MemorialGraphic(
      id: 'floral_eucalyptus_wreath',
      category: 'Floral Designs',
      name: 'Eucalyptus Wreath',
      imageFile: 'floral_eucalyptus_wreath.png',
    ),
    MemorialGraphic(
      id: 'floral_camellia_elegance',
      category: 'Floral Designs',
      name: 'Blush Camellia',
      imageFile: 'floral_camellia_elegance.png',
    ),
    MemorialGraphic(
      id: 'floral_golden_filigree_divider',
      category: 'Floral Designs',
      name: 'Gold Filigree Divider',
      imageFile: 'floral_golden_filigree_divider.png',
    ),
    MemorialGraphic(
      id: 'floral_forget_me_not_garland',
      category: 'Floral Designs',
      name: 'Forget-me-not Garland',
      imageFile: 'floral_forget_me_not_garland.png',
    ),
    MemorialGraphic(
